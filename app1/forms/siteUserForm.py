...
class SiteUserUpdateForm(forms.Form):
    ...
    password = forms.CharField(label='パスワード',
                               strip=False,
                               required=False,
                               widget=forms.PasswordInput(render_value=True, attrs={'class': 'form-control', 'placeholder': 'パスワードは変更するときのみ入力してください'}))
        ...
        if self.errors:
            ...
            for field_key in self.fields:
                ...
                if field_key in self.errors:
                    ...
                    self.fields[field_key].widget.attrs['class'] = 'form-control is-invalid'
